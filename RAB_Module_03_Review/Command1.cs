...
namespace RAB_Module_03_Review
{
    ...
    public class Command1 : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            using (Transaction t = new Transaction(doc))
            {
                ...
                foreach (SpatialElement curRoom in collector)
                {
                    ...
                    // 7. loop through furniture set data
                                ...
                                foreach (FurnitureType curType in furnitureTypes)
                                {
                                    if (furnItem.Trim() == curType.Name)
                                    {
                                        ...
                                        if(curFS != null)
                                        {
                                            ...
                                            FamilyInstance curFI = doc.Create.NewFamilyInstance(insPoint,
        ...
        private FamilySymbol GetFamilySymbolByName(Document doc, string familyName, string typeName)
        {
            ...
            {
                if (fs.Name == typeName && fs.FamilyName == familyName)
                    return fs;
            }
        ...
        {
            //IList<Parameter> paramList = curElem.GetParameters(paramName);
        ...
        private List<string[]> GetFurnitureTypes()
        {
            ...
            returnList.Add(new string[] { "task chair", "Chair-Task", "Chair-Taskzzzzzzz" });
